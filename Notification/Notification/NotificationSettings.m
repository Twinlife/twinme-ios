    ...
    switch (type) {
        case NotificationSoundTypeNotification:
            return [[NSArray alloc] initWithObjects:
                    ...
                    [[NotificationSoundSetting alloc] initWithType:NotificationSoundTypeNotification name:@"Arcade" soundId:0 soundPath:@"mario_notif.caf"],
                    [[NotificationSoundSetting alloc] initWithType:NotificationSoundTypeNotification name:@"BreakingNews" soundId:0 soundPath:@"notification_4.caf"],
                    [[NotificationSoundSetting alloc] initWithType:NotificationSoundTypeNotification name:@"Cosmic" soundId:0 soundPath:@"notification_5.caf"],
                    [[NotificationSoundSetting alloc] initWithType:NotificationSoundTypeNotification name:@"Office" soundId:0 soundPath:@"notification_6.caf"],
                    [[NotificationSoundSetting alloc] initWithType:NotificationSoundTypeNotification name:@"Horizon" soundId:0 soundPath:@"notification_7.caf"],
                    nil];
