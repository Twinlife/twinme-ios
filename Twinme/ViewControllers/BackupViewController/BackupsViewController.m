...
- (void)initViews {
    ...
    [self setNavigationTitle:TwinmeLocalizedStringFromTable(@"account_view_controller_backup_list", @"LocalizableBackup", nil)];
    ...
    self.invalidBackupBarButtonItem.accessibilityLabel = TwinmeLocalizedStringFromTable(@"backups_view_controller_invalidate_backup", @"LocalizableBackup", nil);
    ...
    self.noBackupLabel.text =  TwinmeLocalizedStringFromTable(@"backups_view_controller_no_backup_message", @"LocalizableBackup", nil);
    ...
    self.startBackupView.accessibilityLabel = TwinmeLocalizedStringFromTable(@"backup_view_controller_new_backup", @"LocalizableBackup", nil);
    ...
    self.startBackupLabel.text = TwinmeLocalizedStringFromTable(@"backup_view_controller_new_backup", @"LocalizableBackup", nil);
}
...
- (IBAction)invalidBackupsAction:(id)sender {
    ...
    NSString *message = [NSString stringWithFormat:@"%@\n\n%@", TwinmeLocalizedStringFromTable(@"backups_view_controller_invalidate_backup_message_part_one", @"LocalizableBackup", nil), TwinmeLocalizedStringFromTable(@"backups_view_controller_invalidate_backup_message_part_two", @"LocalizableBackup", nil)];
    DefaultConfirmView *defaultConfirmView = [[DefaultConfirmView alloc] init];
    defaultConfirmView.bottomSheetViewDelegate = self;
    [defaultConfirmView initWithTitle:TwinmeLocalizedStringFromTable(@"backups_view_controller_invalidate_backup", @"LocalizableBackup", nil) message:message image:nil avatar:nil action:TwinmeLocalizedString(@"application_delete", nil) actionColor:Design.DELETE_COLOR_RED cancel:TwinmeLocalizedString(@"application_cancel", nil)];
...
- (void)handleStartBackupTapGesture:(UITapGestureRecognizer *)sender {
    ...
    if (sender.state == UIGestureRecognizerStateEnded) {
        ...
        if ([self.twinmeApplication startOnboarding:OnboardingTypeBackup]) {
            ...
            NSString *title = TwinmeLocalizedStringFromTable(@"account_view_controller_backup", @"LocalizableBackup", nil);
            NSString *message = TwinmeLocalizedStringFromTable(@"backup_view_controller_onboarding", @"LocalizableBackup", nil);
            NSString *action = TwinmeLocalizedStringFromTable(@"backup_view_controller_backup", @"LocalizableBackup", nil);
