...
- (nonnull NSString *)getContentTitle {
    ...
    switch (self.backupContentType) {
        case BackupContentTypeContacts:
            title = TwinmeLocalizedString(@"share_view_controller_contact_list_title", nil);
            break;
            
        case BackupContentTypeGroups:
            title = TwinmeLocalizedString(@"share_view_controller_group_list_title", nil);
            break;
            
        case BackupContentTypeSpaces:
            //TODO BKP: i18n
            title = TwinmeLocalizedString(@"spaces_view_controller_title", nil);
            break;
