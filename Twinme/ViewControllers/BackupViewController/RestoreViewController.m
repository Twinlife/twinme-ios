...
- (void)onBackupHeaderInfoWithHeaderInfo:(nonnull TLBackupHeaderInfo *)headerInfo lastBackupId:(nullable NSUUID *)lastBackupId lastBackupTimestamp:(int64_t)lastBackupTimestamp {
    ...
    self.isBackupHeaderInfoOK = headerInfo != nil && [headerInfo.applicationName isEqualToString:@"skred"];
    ...
    if (self.restoreState == TLRestoreStateStarting && !self.restoreInProgress) {
        ...
        if (self.verifyMode && self.isVerifyBackupTerminated && self.restoreReport && ![self.restoreReport isRestoreUpToDate]) {
            ...
            if (![self.restoreReport.profiles isStatsUpToDate]) {
                ...
                [self.restoreItems addObject:[[UIRestoreItem alloc] initWithType:UIRestoreItemTypeContent text:TwinmeLocalizedStringFromTable(@"restore_view_controller_content_profile_reset", @"LocalizableBackup", nil) icon:[UIImage imageNamed:@"GenerateCode"] value:-1 color:Design.BLACK_COLOR]];
            ...
            if (![self.restoreReport.contacts isStatsUpToDate]) {
                ...
                if (self.restoreReport.contacts.added != 0) {
                    [self.restoreItems addObject:[[UIRestoreItem alloc] initWithType:UIRestoreItemTypeContent text:TwinmeLocalizedStringFromTable(@"backup_view_controller_content_diff_added", @"LocalizableBackup", nil) icon:[UIImage imageNamed:@"ContactsIcon"] value:self.restoreReport.contacts.added color:Design.BLACK_COLOR]];
                }
                
                if (self.restoreReport.contacts.modified != 0) {
                    [self.restoreItems addObject:[[UIRestoreItem alloc] initWithType:UIRestoreItemTypeContent text:TwinmeLocalizedStringFromTable(@"backup_view_controller_content_diff_updated", @"LocalizableBackup", nil) icon:[UIImage imageNamed:@"ActionEdit"] value:self.restoreReport.contacts.modified color:Design.BLACK_COLOR]];
                }
            ...
            if (![self.restoreReport.clickToCall isStatsUpToDate]) {
                [self.restoreItems addObject:[[UIRestoreItem alloc] initWithType:UIRestoreItemTypeSection text:TwinmeLocalizedString(@"premium_services_view_controller_click_to_call_title", nil) icon:nil value:-1 color:nil]];
                
                if (self.restoreReport.clickToCall.added != 0) {
                    [self.restoreItems addObject:[[UIRestoreItem alloc] initWithType:UIRestoreItemTypeContent text:TwinmeLocalizedStringFromTable(@"backup_view_controller_content_diff_added", @"LocalizableBackup", nil) icon:[UIImage imageNamed:@"AddExternalCall"] value:self.restoreReport.clickToCall.added color:Design.BLACK_COLOR]];
                }
                
                if (self.restoreReport.clickToCall.modified != 0) {
                    [self.restoreItems addObject:[[UIRestoreItem alloc] initWithType:UIRestoreItemTypeContent text:TwinmeLocalizedStringFromTable(@"backup_view_controller_content_diff_updated", @"LocalizableBackup", nil) icon:[UIImage imageNamed:@"ActionEdit"] value:self.restoreReport.clickToCall.modified color:Design.BLACK_COLOR]];
                }
                
                if (self.restoreReport.clickToCall.deleted != 0) {
                    [self.restoreItems addObject:[[UIRestoreItem alloc] initWithType:UIRestoreItemTypeContent text:TwinmeLocalizedStringFromTable(@"backup_view_controller_content_diff_deleted", @"LocalizableBackup", nil) icon:[UIImage imageNamed:@"DeleteItem"] value:self.restoreReport.clickToCall.deleted color:nil]];
                    [self.restoreItems addObject:[[UIRestoreItem alloc] initWithType:UIRestoreItemTypeInfo text:TwinmeLocalizedStringFromTable(@"restore_view_controller_content_contact_deleted_message", @"LocalizableBackup", nil) icon:nil value:-1 color:nil]];
                }
            }
