...
@interface ShareContactViewController () <UITableViewDelegate, UITableViewDataSource, UINavigationControllerDelegate, UITextFieldDelegate, UISearchBarDelegate, ContactsServiceDelegate, BottomSheetViewDelegate>
