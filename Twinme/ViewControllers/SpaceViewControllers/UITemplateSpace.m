...
- (void)initTemplateInformation {
    ...
    switch (self.templateType) {
        case TemplateTypeBusiness1:
            self.space = TwinmeLocalizedString(@"spaces_view_sample_business", nil);
            self.profile = TwinmeLocalizedString(@"spaces_view_sample_business_name", nil);
            self.profilePlaceholder = TwinmeLocalizedString(@"template_space_view_template_business_placeholder", nil);
        ...
        case TemplateTypeBusiness2:
            self.space = TwinmeLocalizedString(@"spaces_view_sample_business", nil);
            self.profile = TwinmeLocalizedString(@"template_space_view_template_business_profile", nil);
            self.profilePlaceholder = TwinmeLocalizedString(@"template_space_view_template_business_placeholder", nil);
        ...
        case TemplateTypeFamily1:
            self.space = TwinmeLocalizedString(@"spaces_view_sample_family", nil);
            self.profile = TwinmeLocalizedString(@"spaces_view_sample_family_name", nil);
            self.profilePlaceholder = TwinmeLocalizedString(@"template_space_view_template_family_placeholder", nil);
        ...
        case TemplateTypeFamily2:
            self.space = TwinmeLocalizedString(@"spaces_view_sample_family", nil);
            self.profile = TwinmeLocalizedString(@"template_space_view_template_family_profile", nil);
            self.profilePlaceholder = TwinmeLocalizedString(@"template_space_view_template_family_placeholder", nil);
        ...
        case TemplateTypeFriends1:
            self.space = TwinmeLocalizedString(@"spaces_view_sample_friends", nil);
            self.profile = TwinmeLocalizedString(@"spaces_view_sample_friends_name", nil);
            self.profilePlaceholder = TwinmeLocalizedString(@"template_space_view_template_friends_placeholder", nil);
        ...
        case TemplateTypeFriends2:
            self.space = TwinmeLocalizedString(@"spaces_view_sample_friends", nil);
            self.profile = TwinmeLocalizedString(@"template_space_view_template_friends_profile", nil);
            self.profilePlaceholder = TwinmeLocalizedString(@"template_space_view_template_friends_placeholder", nil);
        ...
        case TemplateTypeOther:
            self.space = TwinmeLocalizedString(@"template_space_view_template_other", nil);
            self.profile = nil;
            self.profilePlaceholder = TwinmeLocalizedString(@"template_space_view_template_other_placeholder", nil);
            self.imageURL = nil;
            self.image = nil;
            self.color = nil;
            break;
