...
@interface ConversationsViewController () <UITableViewDataSource, UITableViewDelegate, ChatServiceDelegate, UISearchBarDelegate, UISearchControllerDelegate, ConversationsActionDelegate, BottomSheetViewDelegate, AlertMessageViewDelegate, CustomTabViewDelegate, SearchSectionDelegate, EnableNotificationDelegate, MenuConversationShorcutDelegate, MenuSelectValueDelegate>
