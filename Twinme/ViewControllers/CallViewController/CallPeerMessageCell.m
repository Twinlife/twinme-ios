...
//
// Implementation: CallPeerMessageCell
//

#undef LOG_TAG
#define LOG_TAG @"CallPeerMessageCell"
...
- (void)bindWithItem:(PeerMessageItem *)item callConversationView:(CallConversationView *)callConversationView  {
    ...
    CGFloat topMargin = [callConversationView getTopMarginWithMask:item.corners & ITEM_TOP_LEFT item:item];
    self.contentLabelTopConstraint.constant = topMargin;
    self.contentLabelBottomConstraint.constant = [callConversationView getBottomMarginWithMask:item.corners & ITEM_BOTTOM_LEFT item:item];
