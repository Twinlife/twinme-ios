...
@implementation PeerCallItem

- (instancetype)initWithCallDescriptor:(TLCallDescriptor *)callDescriptor {
    
    self = [super initWithType:ItemTypePeerCall descriptor:callDescriptor];
    
    if (self) {
        _peerCallDescriptor = callDescriptor;
        self.copyAllowed = NO;
    }
    return self;
}
...
- (NSString *)description {
    ...
    [string appendString:@"PeerCallItem\n"];
