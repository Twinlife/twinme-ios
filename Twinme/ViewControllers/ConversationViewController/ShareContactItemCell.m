...
- (void)bindWithItem:(Item *)item conversationViewController:(ConversationViewController *)conversationViewController {
    ...
    self.messageLabel.textColor = [self.customAppearance getMessageTextColor];
    [self.contentShareView setBackgroundColor:[self.customAppearance getMessageBackgroundColor]];
    ...
    if (shareContactItem.contactShareDescriptor) {
        ...
        [attributedString appendAttributedString:[[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:TwinmeLocalizedString(@"conversation_view_share_contact_item_local_message", nil), shareContactItem.contactShareDescriptor.name, contact.name] attributes:[NSDictionary dictionaryWithObjectsAndKeys:Design.FONT_MEDIUM32, NSFontAttributeName, [self.customAppearance getMessageTextColor], NSForegroundColorAttributeName, nil]]];
        [attributedString appendAttributedString:[[NSMutableAttributedString alloc] initWithString:@"\n"]];
        [attributedString appendAttributedString:[[NSMutableAttributedString alloc] initWithString:message attributes:[NSDictionary dictionaryWithObjectsAndKeys:Design.FONT_MEDIUM30, NSFontAttributeName, [self.customAppearance getMessageTextColor], NSForegroundColorAttributeName, nil]]];
...
- (void)drawRect:(CGRect)rect {
    ...
    self.borderLayer.frame = self.contentShareView.bounds;
    [self.contentShareView.layer addSublayer:self.borderLayer];
