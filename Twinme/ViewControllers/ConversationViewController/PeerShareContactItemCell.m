...
- (void)bindWithItem:(Item *)item conversationViewController:(ConversationViewController *)conversationViewController {
    ...
    self.messageLabel.textColor = [self.customAppearance getPeerMessageTextColor];
    [self.contentShareView setBackgroundColor:[self.customAppearance getPeerMessageBackgroundColor]];
