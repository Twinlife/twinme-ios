...
- (void)initWithActions {
    ...
    [self.actions addObject:[[UIActionConversation alloc]initWithConversationActionType:ConversationActionTypeGif spaceSettings:[twinmeContext defaultSpaceSettings] enabled:self.sendAllowed]];
