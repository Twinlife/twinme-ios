...
- (void)awakeFromNib {
    ...
    self.speedView.backgroundColor = Design.LIGHT_GREY_BACKGROUND_COLOR;
    ...
    self.speedLabel.textColor = Design.FONT_COLOR_DEFAULT;
...
- (void)bindWithItem:(Item *)item conversationViewController:(ConversationViewController *)conversationViewController asyncManager:(AsyncManager *)asyncManager {
    ...
    if (peerAudioItem.visibleAvatar && [conversationViewController displayPeerItemAvatar]) {
        ...
        if (![conversationViewController displayPeerItemAvatar]) {
            ...
            if ([conversationViewController isSelectItemMode]) {
                self.contentAudioViewLeadingConstraint.constant = self.checkMarkViewLeadingConstraint.constant + self.checkMarkViewLeadingConstraint.constant + Design.AVATAR_CONVERSATION_LEADING;
            } else {
                self.contentAudioViewLeadingConstraint.constant = Design.AVATAR_CONVERSATION_LEADING;
            }
        }
    }
